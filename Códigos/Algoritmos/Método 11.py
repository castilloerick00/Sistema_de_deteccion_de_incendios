...
def detect_fire(image, R, G, B):                                                       # Detecta fuego en una imagen usando el modelo de color PJF
    ...
    ################################ RGB-1 ################################
    R_media = np.mean(R)                                                        # Calcular la media del canal rojo
    condicion1 = (R > G) & (G > B)                                              # Filtrado de color segun el modelo estadístico del paper
    ...
    fire_mask_f1 = mascara_fuego & fire_mask
    fire_mask_f1 = fire_mask_f1.astype(np.uint8) * 255
    ################################ RGB-1 ################################
...
output_folder = '/home/pi/TESIS/Codigos/Imagenes/Resultados/Color/Escenario1/H1'
os.makedirs(output_folder, exist_ok=True)
log_file = '/home/pi/TESIS/Codigos/Imagenes/Resultados/Color/Escenario1/H1/deteccion_fuego.txt'
...
archivo_nuevo = '/home/pi/TESIS/Codigos/Metricas/Barras_y_Lineal/Metodo 11.csv'
archivo_original1 = '/home/pi/TESIS/Codigos/Metricas/Barras_y_Lineal/monitoreo.png'
archivo_nuevo1 = '/home/pi/TESIS/Codigos/Metricas/Barras_y_Lineal/Metodo 11.png'
